...
public class GameStatus {
    ...
    public static final int WAIT_POLICE_DEDUCE_INFO = 3;
    public static final int WAIT_POLICE_PROPOSAL_INFO = 4;
    public static final int WAIT_POLICE_VOTE_INFO = 5;
    public static final int WAIT_PLAYER_MOVEMENT_INFO = 6;
